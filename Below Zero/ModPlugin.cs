...
namespace MedkitHotkey
{
    ...
    {
        public const string modGUID = "Dingo.SNBZ.MedkitHotkey";
        public const string modName = "Medkit Hotkey BZ";
        ...
        private void Awake()
        {
            ...
            // BZ uses old keybinding system, handled keybind in options
